...
def encode_csv():
    input_csv = r"C:\Users\ezequ\DOLPH\Skills Matching\Embeddings Generation\filtered_skills_10M.csv"
    output_csv = r"C:\Users\ezequ\DOLPH\Skills Matching\Embeddings Generation\filtered_skills_10M_emb_v1.csv"
    model_name = r'C:\Users\ezequ\DOLPH\Skills Matching\SentenceEmbeddingsApproach\5-ModelInferences\Models\v1'
    label_name = "SkillName"
    max_tokens = 30
    batch_size = 100
    device = "cpu"
    ...
    print(f"[✓] Processed {len(df)} rows; saved with embeddings to '{output_csv}'")
